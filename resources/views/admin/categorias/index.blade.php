        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-6 ml-auto mr-auto">
                    <h1 class="m-0 text-dark text-center">Lista de Categorias</h1>
                </div>
            </div>
        </div>
    </div>
                          ...
                          <table id="tabla-categoria" class="table table-bordered table-striped">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td align="center">
                                  <a href="{{ route('admin.categorias.edit', $categoria->id) }}" class="btn btn-info rounded-circle" style="padding-top: 5px;padding-bottom: 5px;padding-right: 10px;padding-left: 10px;">
