        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-6 ml-auto mr-auto">
                    <h1 class="m-0 text-dark text-center">Detalle de Compra</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
              <div class="invoice p-3 mb-3">
                ...
                <div class="row no-print">
                  <div class="col-12">
                    <a href="{{ route('admin.compras.print', $compra->id) }}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Imprimir</a>
                    <a href="{{ route('admin.compras.pdf', $compra->id)}}" target="_blank" class="btn btn-primary float-right" style="margin-right: 5px;">
